...
gallery/switchable/1.3/base
gallery/switchable/1.3/accordion/base
gallery/switchable/1.3/carousel/base
gallery/switchable/1.3/slide/base
gallery/switchable/1.3/tabs/base
gallery/switchable/1.3/lazyload
gallery/switchable/1.3/effect
gallery/switchable/1.3/circular
gallery/switchable/1.3/aria
gallery/switchable/1.3/carousel/aria
gallery/switchable/1.3/autoplay
gallery/switchable/1.3/tabs/aria
gallery/switchable/1.3/accordion/aria
gallery/switchable/1.3/touch
gallery/switchable/1.3/index

*/
/**
 * Switchable
 */
KISSY.add('gallery/switchable/1.3/base',function (S, DOM, Event, undefined) {
 ...
 */
KISSY.add('gallery/switchable/1.3/accordion/base',function (S, DOM, Switchable) {
 ...
 */
KISSY.add('gallery/switchable/1.3/slide/base',function (S, Switchable) {
 ...
 * @author lifesinger@gmail.com
 */
KISSY.add('gallery/switchable/1.3/tabs/base',function(S, Switchable) {
 ...
 */
KISSY.add('gallery/switchable/1.3/lazyload',function (S, DOM, Switchable) {
 ...
 */
KISSY.add('gallery/switchable/1.3/effect',function (S, DOM, Event, Anim, Switchable, undefined) {
 ...
 * @author lifesinger@gmail.com, yiminghe@gmail.com
 */
KISSY.add('gallery/switchable/1.3/circular',function (S, DOM, Anim, Switchable) {
 ...
 * @author yiminghe@gmail.com
 */
KISSY.add('gallery/switchable/1.3/carousel/aria',function (S, DOM, Event, Aria, Carousel, Switchable) {
 ...
 */
KISSY.add('gallery/switchable/1.3/autoplay',function (S, DOM, Event, Switchable, undefined) {
    var DURATION = 200,
        win = S.Env.host,
 ...
 * @author yiminghe@gmail.com
 */
KISSY.add('gallery/switchable/1.3/tabs/aria',function (S, DOM, Event, Switchable, Aria, Tabs) {
 ...
 * @author yiminghe@gmail.com
 */
KISSY.add('gallery/switchable/1.3/accordion/aria',function (S, DOM, Event, Aria, Accordion, Switchable) {
 ...
 * @author yiminghe@gmail.com
 */
KISSY.add('gallery/switchable/1.3/touch',function (S, DOM, Event, Switchable, DD) {
 ...
 * switchable
 */
KISSY.add('gallery/switchable/1.3/index',function (S, Switchable, Accordion, Carousel, Slide, Tabs) {
    var re = {
        Accordion: Accordion,
        Carousel: Carousel,
        Slide: Slide,
