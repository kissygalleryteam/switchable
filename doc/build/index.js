...
kg/switchable/2.0.0/base
kg/switchable/2.0.0/accordion/base
kg/switchable/2.0.0/carousel/base
kg/switchable/2.0.0/slide/base
kg/switchable/2.0.0/tabs/base
kg/switchable/2.0.0/lazyload
kg/switchable/2.0.0/effect
kg/switchable/2.0.0/circular
kg/switchable/2.0.0/aria
kg/switchable/2.0.0/carousel/aria
kg/switchable/2.0.0/autoplay
kg/switchable/2.0.0/tabs/aria
kg/switchable/2.0.0/accordion/aria
kg/switchable/2.0.0/index

*/
/**
 * Switchable
 */
KISSY.add('kg/switchable/2.0.0/base',function (S, DOM, Event, undefined) {
 ...
 */
KISSY.add('kg/switchable/2.0.0/accordion/base',function (S, DOM, Switchable) {
 ...
 */
KISSY.add('kg/switchable/2.0.0/carousel/base',function (S, DOM, Event, Switchable) {
 ...
 */
KISSY.add('kg/switchable/2.0.0/slide/base',function (S, Switchable) {
 ...
 * @author lifesinger@gmail.com
 */
KISSY.add('kg/switchable/2.0.0/tabs/base',function(S, Switchable) {
 ...
 */
KISSY.add('kg/switchable/2.0.0/lazyload',function (S, DOM, Switchable) {
 ...
 */
KISSY.add('kg/switchable/2.0.0/effect',function (S, DOM, Event, Anim, Switchable, undefined) {
 ...
 * @author lifesinger@gmail.com, yiminghe@gmail.com
 */
KISSY.add('kg/switchable/2.0.0/circular',function (S, DOM, Anim, Switchable) {
 ...
 */
KISSY.add('kg/switchable/2.0.0/aria',function(S, DOM, Event, Switchable) {
 ...
 * @author yiminghe@gmail.com
 */
KISSY.add('kg/switchable/2.0.0/carousel/aria',function (S, DOM, Event, Aria, Carousel, Switchable) {
 ...
 */
KISSY.add('kg/switchable/2.0.0/autoplay',function (S, DOM, Event, Switchable, undefined) {
    var DURATION = 200,
        win = S.Env.host,
 ...
 * @author yiminghe@gmail.com
 */
KISSY.add('kg/switchable/2.0.0/tabs/aria',function (S, DOM, Event, Switchable, Aria, Tabs) {
 ...
 * @author yiminghe@gmail.com
 */
KISSY.add('kg/switchable/2.0.0/accordion/aria',function (S, DOM, Event, Aria, Accordion, Switchable) {
 ...
 * switchable
 */
KISSY.add('kg/switchable/2.0.0/index',function (S, Switchable, Accordion, Carousel, Slide, Tabs) {
    var re = {
        Accordion: Accordion,
        Carousel: Carousel,
        Slide: Slide,
