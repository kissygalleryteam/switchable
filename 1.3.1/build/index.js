...
gallery/switchable/1.3.1/base
gallery/switchable/1.3.1/accordion/base
gallery/switchable/1.3.1/carousel/base
gallery/switchable/1.3.1/slide/base
gallery/switchable/1.3.1/tabs/base
gallery/switchable/1.3.1/lazyload
gallery/switchable/1.3.1/effect
gallery/switchable/1.3.1/circular
gallery/switchable/1.3.1/aria
gallery/switchable/1.3.1/carousel/aria
gallery/switchable/1.3.1/autoplay
gallery/switchable/1.3.1/tabs/aria
gallery/switchable/1.3.1/accordion/aria
gallery/switchable/1.3.1/index

*/
/**
 * Switchable
 */
KISSY.add('gallery/switchable/1.3.1/base',function (S, DOM, Event, undefined) {
 ...
 */
KISSY.add('gallery/switchable/1.3.1/accordion/base',function (S, DOM, Switchable) {
 ...
 */
KISSY.add('gallery/switchable/1.3.1/carousel/base',function (S, DOM, Event, Switchable) {
 ...
 */
KISSY.add('gallery/switchable/1.3.1/slide/base',function (S, Switchable) {
 ...
 * @author lifesinger@gmail.com
 */
KISSY.add('gallery/switchable/1.3.1/tabs/base',function(S, Switchable) {
 ...
 */
KISSY.add('gallery/switchable/1.3.1/lazyload',function (S, DOM, Switchable) {
 ...
 */
KISSY.add('gallery/switchable/1.3.1/effect',function (S, DOM, Event, Anim, Switchable, undefined) {
 ...
 * @author lifesinger@gmail.com, yiminghe@gmail.com
 */
KISSY.add('gallery/switchable/1.3.1/circular',function (S, DOM, Anim, Switchable) {
 ...
 */
KISSY.add('gallery/switchable/1.3.1/aria',function(S, DOM, Event, Switchable) {
 ...
 * @author yiminghe@gmail.com
 */
KISSY.add('gallery/switchable/1.3.1/carousel/aria',function (S, DOM, Event, Aria, Carousel, Switchable) {
 ...
 */
KISSY.add('gallery/switchable/1.3.1/autoplay',function (S, DOM, Event, Switchable, undefined) {
    var DURATION = 200,
        win = S.Env.host,
 ...
 * @author yiminghe@gmail.com
 */
KISSY.add('gallery/switchable/1.3.1/tabs/aria',function (S, DOM, Event, Switchable, Aria, Tabs) {
 ...
 * @author yiminghe@gmail.com
 */
KISSY.add('gallery/switchable/1.3.1/accordion/aria',function (S, DOM, Event, Aria, Accordion, Switchable) {
 ...
 * switchable
 */
KISSY.add('gallery/switchable/1.3.1/index',function (S, Switchable, Accordion, Carousel, Slide, Tabs) {
    var re = {
        Accordion: Accordion,
        Carousel: Carousel,
        Slide: Slide,
